    ...
    "INDIA": {
        ...
        "sections": [
            ...
            ("Deduction Limits (Old Regime)", [
                "Section 80C: Up to ₹1,50,000 (ELSS, PPF, EPF, NSC, Life Insurance, home loan principal, tuition fee).",
                ...
                "Section 80E: Full deduction on interest paid on education loan for higher studies.",
                "Section 80EEA: ₹1,50,000 additional for first-time homebuyers (stamp duty value ≤ ₹45 lakh).",
                "Section 80G: 50% or 100% deduction on donations to approved funds/institutions.",
                "Section 80TTA: ₹10,000 deduction on savings bank interest.",
                "Section 80TTB: ₹50,000 for senior citizens on interest income.",
                "HRA Exemption: Minimum of (actual HRA; 50/40% of salary; excess of rent over 10% of salary).",
                "LTA Exemption: Leave Travel Allowance for actual travel expenses (twice in a block of 4 years).",
            ]),
            ("Capital Gains Tax", [
